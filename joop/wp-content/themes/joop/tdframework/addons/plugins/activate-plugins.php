...
function core_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name' 					=> 'TD Shortcodes',
			'slug' 					=> 'td-shortcodes',
			'source'   				=> THEME_PATH . '/tdframework/addons/plugins/td-shortcodes.zip',
			'required' 				=> false,
			'version' 				=> '',
		...
		array(
			'name' 					=> 'LayerSlider WP',
			'slug' 					=> 'LayerSlider',
			'source'   				=> THEME_PATH . '/tdframework/addons/plugins/LayerSlider.zip',
			'required' 				=> false,
			'version' 				=> '4.6.0',
			'force_activation' 		=> false,
			'force_deactivation' 	=> false,
		...
		array(
			...
			'slug' 					=> 'js_composer',
			'source'   				=> THEME_PATH . '/tdframework/addons/plugins/js_composer.zip',
			'required' 				=> false,
			'version' 				=> '',
			'force_activation' 		=> false,
			'force_deactivation' 	=> false,
